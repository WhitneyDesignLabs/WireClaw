...
/* P01-v2 boot-time sanity check for the prose-tool-call leak detector.
 * Prints PASS/FAIL for 4 cases (1 captured leak, 1 negative, 1 regression
 * for v1, 1 documented false-positive edge). Call once early in setup(). */
