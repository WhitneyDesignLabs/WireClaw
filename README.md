...
> ## WhitneyDesignLabs Fork
>
> This is a fork of [M64GitHub/WireClaw](https://github.com/M64GitHub/WireClaw) with prompt + tool refinements and an optional baked-model package (`wireclaw-agent:v1`, llama3.1:8b base) for local-LLM operators on 8 GB-class GPUs.
>
> If you landed here looking for the WhitneyDesignLabs flavor, see **[README-WhitneyDesignLabs.md](README-WhitneyDesignLabs.md)** for what this fork adds, when to use which mode, and the documented limits. The package branch is **`wdl-v1`**. The bake recipe is in **[bake/](bake/)**.
>
